    ...
    for (let item of books) {
      output += `
        <div class="book">
          ...
          <form><button class="buybtn" data-book='${JSON.stringify(
            item
          )}'>Buy Now</button> 
        </div>
      `;
...
function showOrderPopup(event) {
  ...
  // Create form for Razorpay payment button script element
  ...
  paymentForm.appendChild(razorpayScript);
  popupContent.appendChild(closeBtn);
  popupContent.appendChild(paymentForm); // Append the form containing the Razorpay payment button script
